...
{
	[Activity (Label = "Kibic 2.0", MainLauncher = false, ScreenOrientation=Android.Content.PM.ScreenOrientation.ReverseLandscape)]
	public class PierwszyEkran2 : Activity
	{
		...
		//	buttonGoraPierwszy.SetBackgroundColor (Android.Graphics.Color.Black);
			...
			buttonOpcje1.Visibility = Android.Views.ViewStates.Gone;
